...
import { Text, View, Linking, Modal, Picker, Button, TouchableHighlight, PermissionsAndroid, Platform, StyleSheet, ImageBackground} from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <Button onPress={() => this.togglePicker()} title={ "Selecione o Serviço" } />
        { <Picker
